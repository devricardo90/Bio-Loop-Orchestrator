...
assert.match(page, /Buyer source=api first/i);
assert.match(page, /Admin closeout with catalogScope/i);
...
assert.match(dashboard, /source=api/);
...
assert.match(pickupDashboard, /source=api/);
...
assert.match(appHeader, /API reference/);
...
assert.match(apiReferencePanel, /Open \/reference/);
